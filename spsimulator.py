...
##                                                                           ##
## Simulator where the nodes use the shortest path algorithm (SPA).          ##
##                                                                           ##
##  TODO:                                                                    ##
##                                                                           ##
...
class SPSimulator:
    ...
    def create_node(self, addr, x, y, depth, energy):
        ...
        node = USPNode(addr, x, y, depth, energy, self.clock, self.verbose)
    ...
    def start(self, stopExec):
        ...
        for slot in range(0, numSlots):
            ...
            while remainingTime > 0:
                ...
                isAcoustic = (msg.flags & USPFlags.ACOUSTIC)
                needACK = (msg.flags & USPFlags.WITH_ACK)
