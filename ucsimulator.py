...
class UCSimulator:
    ...
    def create_node(self, addr, x, y, depth, energy):
        ...
        node = UCNode(addr, x, y, depth, energy, self.clock, self.verbose)
        ...
        for slot in range(0, numSlots):
            ...
            while remainingTime > 0:
                ...
                for dst in destinations:
                    if self.verbose:
                        print('Sending message to ' + str(dst) + ' rtime: ' + str(remainingTime))
            ...
            assert remainingTime >= -1e-10, 'error: time interval was not ' + \
